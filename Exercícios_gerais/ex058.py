...
comp = randint(0, 10)
print('Sou seu computador... Pensei em um número entre 0 e 10. Acerte e não apagarei no meio da escrita do TCC')
acertou = False
palps = 0
while not acertou:
...
print('Acertou com {} tentativas. Parabéns'.format(palps))
